...
<body>
    ...
    <header class="topbar shadow-sm">
        ...
        <div class="d-flex align-items-center gap-4">
            <button class="btn-sidebar-toggle text-primary-green gap-2 gap-md-4">
            ...
            <div class="d-flex align-items-center gap-2 gap-md-3">
                ...
                <h3 class="mb-0 fw-bold text-primary-green logo-text d-none d-md-block text-nowrap" style="font-family: Arial, sans-serif; letter-spacing: 0.5px; vertical-align: middle;">
                ...
                if (keyword !== '') {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            ...
                            // Hapus alert jika mengganggu, ganti modal/toast
                        },
                        complete: function() {
                            setTimeout(() => { 
